...
export default function Home(){
    ...
    return (
      <>
            <h1>Accueil</h1>
            <p className="text">Trouve ton match est une appli qui vous permettra de trouver LA personne pour vous accompagner et vous soutenir, une épaule sur laquelle vous reposer.</p>
